...
import { AddProjectForm } from "./addProjectDailog";
import { EditProjectForm } from "./editProjectDailog";
import ProjectResizableRowDetail from "./projectResizeableRowDetail";
...
export function ProjectTableDetails() {
  ...
  const columns: ColumnDef<ProjectDetails>[] = [
    {
